...
0.24:	- applied patch to work with PythonOCC 0.16 (credits: Niels Linnemann)
...
The code has been tested with Python 2.7.10, http://www.python.org
...
5. matplotlib (1.4.3), http://matplotlib.sourceforge.net (for example problems)
it is strongly recommended to use the same versions of the modules as pyGear likely won't work with older versions. Later versions might work, but this has not been tested.
